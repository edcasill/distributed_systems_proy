...
def procesar_frame(frame, model, last_box_cache, ultimo_estado, ultimo_envio, camara_id, COOLDOWN_API):
    ...
    return frame, datos_a_dibujar, ultimo_estado, ultimo_envio
...
def video_model():
    ...
    while True:
        ...
        if frame_count % 5 == 0:
            # Procesar camara 1
            frame1, cache_cam1, estado_cam1, envio_cam1 = procesar_frame(frame1, model, cache_cam1,
                                                                         estado_cam1, envio_cam1, 1, COOLDOWN_API)

            # Procesar camara 2
            frame2, cache_cam2, estado_cam2, envio_cam2 = procesar_frame(frame2, model, cache_cam2,
                                                                         estado_cam2, envio_cam2, 2, COOLDOWN_API)
        else:
